...
password_gen = Tk()
password_gen.configure(background="Blue")
password_gen.geometry("350x200")
password_gen.title("Vishal Random Password Generator")
title_label = Label(password_gen, text="Vishal Random Password Generator", font=('Ubuntu Mono', 12))
title_label.pack()
...
repeat_label = Label(password_gen, text="Repetition Press 1: no repetition, 2: otherwise: ")
repeat_label.place(x=20, y=60)
repeat_entry = Entry(password_gen, width=3)
repeat_entry.place(x=300, y=60)
password_button = Button(password_gen, text="Generate Password", command=generate_password,bg="Red")
